...
VERILATOR_FLAGS = --cc --exe --Mdir $(OBJ_DIR) -y $(INCLUDE_DIR) --prefix $(PREFIX_NAME) --top-module $(TOP_NAME) -o $(BIN) -j 0 $(VOPTIMIZE) $(VWARNING) $(addprefix -CFLAGS , $(VERILATOR_CFLAGS))
